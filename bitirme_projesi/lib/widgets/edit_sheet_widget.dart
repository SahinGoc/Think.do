...
class EditSheetWidget extends StatefulWidget {
  late Todo todo;

  EditSheetWidget(this.todo);

  @override
  State<EditSheetWidget> createState() => _EditSheetWidgetState(todo);
}

class _EditSheetWidgetState extends State<EditSheetWidget> {
  late Todo todo;

  _EditSheetWidgetState(this.todo);
  ...
  void initState() {
    ...
    dscrptnController.text = todo.description!;
    categoryController.text = todo.category;
    dateController.text = todo.date.toString();
    timeController.text = todo.time.toString();
    newCategoryController.text = '';
    selectedMenuItem = todo.category;
    isEnable = true;
    super.initState();
  }
                ...
                onPressed: () {
                  if (titleController.text != '' &&
                    ...
                    Todo todo = new Todo(
                        ...
                        timeController.text,
                        'deneme',
                        this.todo.createTime.toString(),
                        '',
                        '');
                    if (categoryController.text == this.todo.category) {
                      todoService.todoUpdate(todo);
                    } else {
                      todoService.todoAdd(todo);
                      todoService.todoDelete(
                          this.todo.category, this.todo.createTime.toString());
                    }
                    buildFieldClean();
                  } else {
